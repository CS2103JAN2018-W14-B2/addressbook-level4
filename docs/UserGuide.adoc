...
. To apply the 2nd employee in the list for shift 3, execute the command `apply 2 3` as shown in _<<fig-applyAdminBefore>>_ below.
+
...
. To remove the 2nd employee from shift 3, execute the command `unapply 2 3` as shown in _<<fig-unapplyAdminBefore>>_ below.
+
...
. If you are the 2nd employee in the list and you wish to apply for shift 3, execute the command +
...
. If you are the 2nd employee in the list and you wish to remove yourself from shift 3, execute the command +
