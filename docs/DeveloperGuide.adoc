...
Having shifts that are earlier than the current timetable week will cause the visible shifts to have indexes that do not start from 1. To avoid this, we only index shifts that are visible in the current timetable view. +
