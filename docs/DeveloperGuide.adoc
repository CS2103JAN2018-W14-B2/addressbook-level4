...
The `changeadminpassword` command allows employers to change the admin password.
For increased security, `changeadminpassword` command requires the current password for further verification.
This reduces the risk of the password getting stolen. You can find out more information on password in <<Password Class>>.

*Announcement command*

The "announcement" command allows employers to create an announcement visible to all employees.
