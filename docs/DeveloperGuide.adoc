...
This section describes how to run tests, different types of tests and troubleshooting of tests.
...
If you discover any mistakes in the tests, follow this format to troubleshoot testing:

**Problem 1:** `HelpWindowTest` fails with a `NullPointerException`.
